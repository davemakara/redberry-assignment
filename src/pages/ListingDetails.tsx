...
import EXAMPLE_IMG from "../assets/image/Rectangle 37.png";

const ListingDetails = () => {
  return (
    <section className="w-full">
      <div className="w-[1591px] mx-auto mt-[64px] mb-[53px]">
        <Link to="/">
          <svg
            width="32"
            height="32"
        ...
        <div className="flex gap-[68px] mt-[29px] pb-[14px]">
          <div>
            <img
              src={EXAMPLE_IMG}
              alt="example"
            ...
            />
            <p className="text-right text-[#808A93] text-[16px] leading-[19.2px] mt-[14px]">
              გამოქვეყნების თარიღი 08/08/24
            </p>
          </div>
          <div className="w-[503px] h-[714px] pt-[30px] pb-[42px]">
            <div>
              <h2 className="mb-[24px] text-[48px] text-[#021526] font-bold leading-[57.6px]">
                80, 000 ₾
              </h2>
              <div className="flex flex-col gap-[16px] text-[24px] text-[#808A93] leading-[28.8px]">
            ...
            <p className="mt-[40px] mb-[50px] text-[16px] text-[#808A93] leading-[26px] font-normal">
            ...
            <div className="w-full h-[174px] flex flex-col gap-[16px] border border-lightGray rounded-[8px] px-5 py-6">
              <div className="flex items-center gap-[14px]">
                ...
                />
                <div>
                  <p className="text-[16px] text-[#021526] leading-[19.2px] font-normal mb-1">
                    სოფო გელოვანი
                  </p>
                  <p className="text-[14px] text-[#676E76] leading-[16.8px] font-normal">
                    აგენტი
                  </p>
                </div>
              </div>
              <div className="flex flex-col gap-1 text-[14px] text-[#808A93] leading-[16.8px] font-normal">
            ...
            <button className="p-[10px] mt-5 border border-[#676E76] rounded-[8px] text-[12px] text-[#676E76] leading-[14.4px] font-medium hover:bg-[#808A93] hover:text-white">
              ლისტინგის წაშლა
            </button>
          </div>
        </div>
