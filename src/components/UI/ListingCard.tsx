import CARD_IMG from "../../assets/image/Rectangle 37.png";

const ListingCard = () => {
  return (
    <div className="w-[384px] rounded-[14px] hover:shadow-md hover:shadow-lightGray">
      <div className="relative">
        <span className="absolute top-[23px] left-[23px] bg-[#02152680] w-[90px] p-[6px] flex items-center justify-center rounded-[15px]">
          <p className=" text-white text-[12px] leading-[14.4px] tracking-wider">
            იყიდება
          </p>
        </span>
        <img src={CARD_IMG} alt="card img" />
      </div>
      <div className="px-[25px] py-[22px] border border-lightGray rounded-b-[14px] overflow-hidden">
        <h2 className="text-[28px] font-bold leading-[33.6px]">80 000 ₾</h2>
        <div className="flex items-center gap-1 text-[#021526B2] text-[16px] leading-[19.2px] font-normal mt-[6.5px] mb-[20.5px]">
          <svg
            width="14"
            height="17"
            viewBox="0 0 14 17"
        ...
        <div className="flex gap-[32px] text-[#021526B2] text-[16px] leading-[19.2px] font-normal">
